  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/65 backdrop-blur-md">
      <motion.div
        ...
        className="relative w-full max-w-lg bg-[#ffffff] rounded-3xl border border-stone-200 shadow-[0_25px_70px_rgba(0,0,0,0.25)] overflow-hidden"
      >
        {/* Close Button */}
        {onClose && (
          <button
            onClick={onClose}
            className="absolute top-5 right-5 p-1.5 rounded-full bg-stone-100 hover:bg-stone-200 text-zinc-500 hover:text-zinc-900 transition-colors z-20 cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        )}
        ...
        {/* Header Bar */}
        <div className="px-6 sm:px-8 pt-7 pb-5 bg-gradient-to-b from-stone-50 to-white border-b border-stone-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <div className="flex items-center p-1 rounded-xl bg-stone-100 border border-stone-200/80">
              <button
                type="button"
                onClick={() => { setMode("signin"); setErrorMessage(""); }}
                className={`flex items-center gap-1 px-3 py-1 rounded-lg text-xs font-mono font-semibold transition-all cursor-pointer ${
        ...
        {/* Form Body */}
        <form onSubmit={handleSubmit} className="px-6 sm:px-8 py-6 space-y-3.5">
          {errorMessage && (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="name@auraledger.io"
                className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-stone-200 focus:border-zinc-950 bg-stone-50/50 text-xs font-medium focus:outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-stone-200 focus:border-zinc-950 bg-stone-50/50 text-xs font-medium focus:outline-none transition-all"
              />
              <button
                type="button"
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="5000"
                      className="w-full pl-10 pr-3 py-2.5 rounded-xl border border-stone-200 focus:border-zinc-950 bg-stone-50/50 text-xs font-mono font-semibold focus:outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 rounded-xl border border-stone-200 bg-stone-50/50 text-xs font-mono font-semibold focus:outline-none cursor-pointer"
                  >
